-- Allow everyone with a legitimate link to the match (clubs, roster, officials)
-- to READ the scorer-style detail for FINISHED matches. Live/scheduled unchanged.
-- Applied on top of public.get_zapisnicar_match_detail definition in docs/sql-klub-module.sql
