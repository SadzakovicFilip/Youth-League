...
export default function HomeScreen() {
  ...
  const loadPermissions = useCallback(async () => {
    ...
    const uniqueChildRoles = [
      ...new Set(rules.map((rule) => rule.child_role).filter(Boolean)),
    ];
  ...
  useScreenPullRefresh(loadPermissions);
    ...
    <RefreshableScrollView contentContainerStyle={styles.container}>
      ...
      {loadingRoles ? (
        ...
        <ThemedView style={styles.resultBox}>
          <ThemedText>
            Ova rola nema dozvolu za kreiranje novih korisnika.
          </ThemedText>
        </ThemedView>
      ) : (
        <>
            ...
            <View style={styles.roleList}>
              {allowedRoles.map((roleOption) => (
                <Pressable
                  ...
                  style={[
                    styles.roleChip,
                    role === roleOption && styles.roleChipActive,
                  ]}
                >
                  <ThemedText
                    style={
